...
namespace Yafc {
    ...
    public static class ImmediateWidgets {
        ...
        public static bool BuildFloatInput(this ImGui gui, float value, out float newValue, UnitOfMeasure unit, Padding padding) {
            if (gui.BuildTextInput(DataUtils.FormatAmount(value, unit), out string newText, null, Icon.None, true, padding, setInitialFocus: false) && DataUtils.TryParseAmount(newText, out newValue, unit)) {
                return true;
            }
